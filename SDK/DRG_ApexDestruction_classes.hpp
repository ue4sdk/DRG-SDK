...
#include "DRG_ApexDestruction_structs.hpp"
...
public:
	...
	unsigned char                                      bFractureEffectOverride : 1;                              // 0x06C8(0x0001) (CPF_Edit, CPF_BlueprintVisible)
	unsigned char                                      UnknownData01[0x7];                                       // 0x06C9(0x0007) MISSED OFFSET
	TArray<struct FFractureEffect>                     FractureEffects;                                          // 0x06D0(0x0010) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_EditFixedSize, CPF_ZeroConstructor)
	bool                                               bEnableHardSleeping;                                      // 0x06E0(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      UnknownData02[0x3];                                       // 0x06E1(0x0003) MISSED OFFSET
	float                                              LargeChunkThreshold;                                      // 0x06E4(0x0004) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      UnknownData03[0x10];                                      // 0x06E8(0x0010) MISSED OFFSET
	struct FScriptMulticastDelegate                    OnComponentFracture;                                      // 0x06F8(0x0010) (CPF_ZeroConstructor, CPF_InstancedReference, CPF_BlueprintAssignable)
...
{
public:
	struct FDestructibleParameters                     DefaultDestructibleParameters;                            // 0x02F8(0x0088) (CPF_Edit)
	TArray<struct FFractureEffect>                     FractureEffects;                                          // 0x0380(0x0010) (CPF_Edit, CPF_EditFixedSize, CPF_ZeroConstructor)
