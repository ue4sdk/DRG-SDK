...
#include "DRG_BP_MissionStats_structs.hpp"
...
public:
	...
	class UWidgetComponent*                            Widget;                                                   // 0x0348(0x0008) (CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_InstancedReference, CPF_IsPlainOldData)
	...
	{
		static auto ptr = UObject::FindObject<UClass>("BlueprintGeneratedClass BP_MissionStats.BP_MissionStats_C");
		return ptr;
	}
