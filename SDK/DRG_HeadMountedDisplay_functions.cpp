...
#include "DRG_HeadMountedDisplay_classes.hpp"
...
// Parameters:
// struct FTransform              ExternalTrackingTransform      (CPF_ConstParm, CPF_Parm, CPF_OutParm, CPF_ReferenceParm, CPF_IsPlainOldData)
...
// Parameters:
// struct FVector2D               EyeRectMin                     (CPF_Parm, CPF_ZeroConstructor, CPF_IsPlainOldData)
// struct FVector2D               EyeRectMax                     (CPF_Parm, CPF_ZeroConstructor, CPF_IsPlainOldData)
// struct FVector2D               TextureRectMin                 (CPF_Parm, CPF_ZeroConstructor, CPF_IsPlainOldData)
// struct FVector2D               TextureRectMax                 (CPF_Parm, CPF_ZeroConstructor, CPF_IsPlainOldData)
...
// bool                           bUseAlpha                      (CPF_Parm, CPF_ZeroConstructor, CPF_IsPlainOldData)
...
// struct FRotator                Orientation                    (CPF_Parm, CPF_OutParm, CPF_ZeroConstructor, CPF_IsPlainOldData)
