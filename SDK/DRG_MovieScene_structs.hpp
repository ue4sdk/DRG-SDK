...
#include "DRG_MovieScene_enums.hpp"
...
{
	struct FGuid                                       ObjectBindingId;                                          // 0x0000(0x0010) (CPF_ZeroConstructor, CPF_IsPlainOldData)
...
{
	struct FSoftObjectPath                             Sequence;                                                 // 0x0000(0x0018) (CPF_ZeroConstructor)
	struct FMovieSceneSequenceTransform                RootToSequenceTransform;                                  // 0x0018(0x000C)
	struct FFrameRate                                  TickResolution;                                           // 0x0024(0x0008) (CPF_ZeroConstructor, CPF_IsPlainOldData)
	...
	struct FGuid                                       SubSectionSignature;                                      // 0x0088(0x0010) (CPF_ZeroConstructor, CPF_IsPlainOldData)
...
struct FMovieSceneEvaluationTemplate
{
	...
	struct FGuid                                       SequenceSignature;                                        // 0x0170(0x0010) (CPF_ZeroConstructor, CPF_IsPlainOldData)
...
{
	unsigned char                                      UnknownData00[0x18];                                      // 0x0000(0x0018) MISSED OFFSET
	TMap<struct FMovieSceneSequenceID, class UObject*> DirectorInstances;                                        // 0x0018(0x0050) (CPF_ZeroConstructor)
...
struct FMovieSceneObjectBindingID
{
	...
	struct FGuid                                       Guid;                                                     // 0x0008(0x0010) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
};
...
struct FMovieSceneSpawnable
{
	...
	struct FGuid                                       Guid;                                                     // 0x0040(0x0010) (CPF_ZeroConstructor, CPF_IsPlainOldData)
...
struct FMovieScenePossessable
{
	...
	struct FGuid                                       Guid;                                                     // 0x0010(0x0010) (CPF_ZeroConstructor, CPF_IsPlainOldData)
	...
	struct FGuid                                       ParentGuid;                                               // 0x0038(0x0010) (CPF_ZeroConstructor, CPF_IsPlainOldData)
};
...
struct FMovieSceneEditorData
{
	...
	struct FFloatRange                                 WorkingRange;                                             // 0x00C0(0x0010) (CPF_ZeroConstructor, CPF_Deprecated, CPF_IsPlainOldData)
	struct FFloatRange                                 ViewRange;                                                // 0x00D0(0x0010) (CPF_ZeroConstructor, CPF_Deprecated, CPF_IsPlainOldData)
};
...
{
	struct FTimecode                                   Timecode;                                                 // 0x0000(0x0014) (CPF_ZeroConstructor, CPF_IsPlainOldData)
...
struct FMovieSceneSubSectionData
{
	...
	struct FGuid                                       ObjectBindingId;                                          // 0x0008(0x0010) (CPF_ZeroConstructor, CPF_IsPlainOldData)
...
struct FMovieSceneFloatChannel : public FMovieSceneChannel
{
	...
	struct FFrameRate                                  TickResolution;                                           // 0x0098(0x0008) (CPF_ZeroConstructor, CPF_IsPlainOldData)
};
