...
#include "DRG_EditableMesh_enums.hpp"
#include "DRG_CoreUObject_classes.hpp"
#include "DRG_MeshDescription_classes.hpp"
...
{
	struct FVertexID                                   VertexID;                                                 // 0x0000(0x0004) (CPF_BlueprintVisible)
	struct FVector                                     NewVertexPosition;                                        // 0x0004(0x000C) (CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
};
...
struct FSubdividedQuadVertex
{
	...
	struct FVector2D                                   TextureCoordinate0;                                       // 0x0004(0x0008) (CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
	struct FVector2D                                   TextureCoordinate1;                                       // 0x000C(0x0008) (CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
	struct FColor                                      VertexColor;                                              // 0x0014(0x0004) (CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
	struct FVector                                     VertexNormal;                                             // 0x0018(0x000C) (CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
	struct FVector                                     VertexTangent;                                            // 0x0024(0x000C) (CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
