...
#include "DRG_HUD_CroDualMachinePistols_classes.hpp"
...
{
	static auto fn = UObject::FindObject<UFunction>("Function HUD_CroDualMachinePistols.HUD_CroDualMachinePistols_C.Construct");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function HUD_CroDualMachinePistols.HUD_CroDualMachinePistols_C.SetData");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function HUD_CroDualMachinePistols.HUD_CroDualMachinePistols_C.OnSpreadChanged");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function HUD_CroDualMachinePistols.HUD_CroDualMachinePistols_C.PreConstruct");
...
void UHUD_CroDualMachinePistols_C::OnDamagedEnemy_Event(const TScriptInterface<class UHealth>& EnemyHealth, float Damage, float DamageModifier, float HealthRemaining)
{
	static auto fn = UObject::FindObject<UFunction>("Function HUD_CroDualMachinePistols.HUD_CroDualMachinePistols_C.OnDamagedEnemy_Event");
...
void UHUD_CroDualMachinePistols_C::ExecuteUbergraph_HUD_CroDualMachinePistols(int EntryPoint)
{
	static auto fn = UObject::FindObject<UFunction>("Function HUD_CroDualMachinePistols.HUD_CroDualMachinePistols_C.ExecuteUbergraph_HUD_CroDualMachinePistols");
