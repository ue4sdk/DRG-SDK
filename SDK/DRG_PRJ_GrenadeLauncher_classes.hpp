...
#include "DRG_PRJ_GrenadeLauncher_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>("BlueprintGeneratedClass PRJ_GrenadeLauncher.PRJ_GrenadeLauncher_C");
		return ptr;
	}
