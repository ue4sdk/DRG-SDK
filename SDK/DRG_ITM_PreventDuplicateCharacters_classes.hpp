...
#include "DRG_ITM_PreventDuplicateCharacters_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>("WidgetBlueprintGeneratedClass ITM_PreventDuplicateCharacters.ITM_PreventDuplicateCharacters_C");
		return ptr;
	}
