...
#include "DRG_Options_InvertMouseWheel_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>("WidgetBlueprintGeneratedClass Options_InvertMouseWheel.Options_InvertMouseWheel_C");
		return ptr;
	}
