...
#include "DRG_Options_HoldToSprint_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>("WidgetBlueprintGeneratedClass Options_HoldToSprint.Options_HoldToSprint_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_Options_HoldToSprint(int EntryPoint);
};
