...
#include "DRG_HUD_CrosAutocannon_classes.hpp"
...
void UHUD_CrosAutocannon_C::OnDamagedEnemy_Event(const TScriptInterface<class UHealth>& EnemyHealth, float Damage, float DamageModifier, float HealthRemaining)
{
