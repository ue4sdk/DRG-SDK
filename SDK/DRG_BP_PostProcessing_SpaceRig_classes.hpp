...
#include "DRG_BP_PostProcessing_SpaceRig_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>("BlueprintGeneratedClass BP_PostProcessing_SpaceRig.BP_PostProcessing_SpaceRig_C");
		return ptr;
	}
