...
#include "DRG_UMG_enums.hpp"
#include "DRG_PropertyPath_classes.hpp"
...
#include "DRG_MovieSceneTracks_classes.hpp"
...
struct FAnchorData
{
	struct FMargin                                     Offsets;                                                  // 0x0000(0x0010) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
...
{
	struct FTextBlockStyle                             TextStyle;                                                // 0x0008(0x01E8) (CPF_Edit)
};
