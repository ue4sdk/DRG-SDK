...
#include "DRG_SlateCore_enums.hpp"
...
struct FSlateBrush
{
	...
	struct FVector2D                                   ImageSize;                                                // 0x0008(0x0008) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
	struct FMargin                                     Margin;                                                   // 0x0010(0x0010) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
	...
	struct FBox2D                                      UVRegion;                                                 // 0x0058(0x0014) (CPF_ZeroConstructor)
...
struct FFontOutlineSettings
{
	...
	unsigned char                                      bSeparateFillAlpha : 1;                                   // 0x0020(0x0001) (CPF_Edit, CPF_BlueprintVisible)
	unsigned char                                      bApplyOutlineToDropShadows : 1;                           // 0x0020(0x0001) (CPF_Edit, CPF_BlueprintVisible)
...
struct FButtonStyle : public FSlateWidgetStyle
{
	...
	struct FMargin                                     NormalPadding;                                            // 0x0228(0x0010) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
	struct FMargin                                     PressedPadding;                                           // 0x0238(0x0010) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
...
struct FComboButtonStyle : public FSlateWidgetStyle
{
	...
	struct FMargin                                     MenuBorderPadding;                                        // 0x0390(0x0010) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
};
...
{
	struct FSlateFontInfo                              Font;                                                     // 0x0008(0x0058) (CPF_Edit, CPF_BlueprintVisible)
	struct FSlateColor                                 ColorAndOpacity;                                          // 0x0060(0x0028) (CPF_Edit, CPF_BlueprintVisible)
	struct FSlateBrush                                 BackgroundImageSelected;                                  // 0x0088(0x0088) (CPF_Edit, CPF_BlueprintVisible)
	struct FSlateBrush                                 BackgroundImageComposing;                                 // 0x0110(0x0088) (CPF_Edit, CPF_BlueprintVisible)
	struct FSlateBrush                                 CaretImage;                                               // 0x0198(0x0088) (CPF_Edit, CPF_BlueprintVisible)
};
...
struct FEditableTextBoxStyle : public FSlateWidgetStyle
{
	...
	struct FMargin                                     Padding;                                                  // 0x0228(0x0010) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
	struct FSlateFontInfo                              Font;                                                     // 0x0238(0x0058) (CPF_Edit, CPF_BlueprintVisible)
	struct FSlateColor                                 ForegroundColor;                                          // 0x0290(0x0028) (CPF_Edit, CPF_BlueprintVisible)
	struct FSlateColor                                 BackgroundColor;                                          // 0x02B8(0x0028) (CPF_Edit, CPF_BlueprintVisible)
	struct FSlateColor                                 ReadOnlyForegroundColor;                                  // 0x02E0(0x0028) (CPF_Edit, CPF_BlueprintVisible)
	struct FMargin                                     HScrollBarPadding;                                        // 0x0308(0x0010) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
	struct FMargin                                     VScrollBarPadding;                                        // 0x0318(0x0010) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
	struct FScrollBarStyle                             ScrollBarStyle;                                           // 0x0328(0x04D0) (CPF_Edit, CPF_BlueprintVisible)
};
...
struct FTextBlockStyle : public FSlateWidgetStyle
{
	struct FSlateFontInfo                              Font;                                                     // 0x0008(0x0058) (CPF_Edit, CPF_BlueprintVisible)
	struct FSlateColor                                 ColorAndOpacity;                                          // 0x0060(0x0028) (CPF_Edit, CPF_BlueprintVisible)
	struct FVector2D                                   ShadowOffset;                                             // 0x0088(0x0008) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
	struct FLinearColor                                ShadowColorAndOpacity;                                    // 0x0090(0x0010) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
	struct FSlateColor                                 SelectedBackgroundColor;                                  // 0x00A0(0x0028) (CPF_Edit)
	struct FLinearColor                                HighlightColor;                                           // 0x00C8(0x0010) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
	struct FSlateBrush                                 HighlightShape;                                           // 0x00D8(0x0088) (CPF_Edit, CPF_BlueprintVisible)
	struct FSlateBrush                                 UnderlineBrush;                                           // 0x0160(0x0088) (CPF_Edit, CPF_BlueprintVisible)
};
...
struct FSpinBoxStyle : public FSlateWidgetStyle
{
	...
	struct FMargin                                     TextPadding;                                              // 0x02D8(0x0010) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
};
...
struct FWindowStyle : public FSlateWidgetStyle
{
	...
	struct FTextBlockStyle                             TitleTextStyle;                                           // 0x09E8(0x01E8) (CPF_Edit, CPF_BlueprintVisible)
	struct FSlateBrush                                 ActiveTitleBrush;                                         // 0x0BD0(0x0088) (CPF_Edit, CPF_BlueprintVisible)
	struct FSlateBrush                                 InactiveTitleBrush;                                       // 0x0C58(0x0088) (CPF_Edit, CPF_BlueprintVisible)
	struct FSlateBrush                                 FlashTitleBrush;                                          // 0x0CE0(0x0088) (CPF_Edit, CPF_BlueprintVisible)
	struct FSlateColor                                 BackgroundColor;                                          // 0x0D68(0x0028) (CPF_Edit, CPF_BlueprintVisible)
	struct FSlateBrush                                 OutlineBrush;                                             // 0x0D90(0x0088) (CPF_Edit, CPF_BlueprintVisible)
	struct FSlateColor                                 OutlineColor;                                             // 0x0E18(0x0028) (CPF_Edit, CPF_BlueprintVisible)
	struct FSlateBrush                                 BorderBrush;                                              // 0x0E40(0x0088) (CPF_Edit, CPF_BlueprintVisible)
	struct FSlateBrush                                 BackgroundBrush;                                          // 0x0EC8(0x0088) (CPF_Edit, CPF_BlueprintVisible)
	struct FSlateBrush                                 ChildBackgroundBrush;                                     // 0x0F50(0x0088) (CPF_Edit, CPF_BlueprintVisible)
};
...
struct FDockTabStyle : public FSlateWidgetStyle
{
	...
	struct FMargin                                     TabPadding;                                               // 0x06C0(0x0010) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
...
struct FSliderStyle : public FSlateWidgetStyle
{
	...
	struct FSlateBrush                                 HoveredBarImage;                                          // 0x0090(0x0088) (CPF_Edit, CPF_BlueprintVisible)
	struct FSlateBrush                                 DisabledBarImage;                                         // 0x0118(0x0088) (CPF_Edit, CPF_BlueprintVisible)
	struct FSlateBrush                                 NormalThumbImage;                                         // 0x01A0(0x0088) (CPF_Edit, CPF_BlueprintVisible)
	struct FSlateBrush                                 HoveredThumbImage;                                        // 0x0228(0x0088) (CPF_Edit, CPF_BlueprintVisible)
	struct FSlateBrush                                 DisabledThumbImage;                                       // 0x02B0(0x0088) (CPF_Edit, CPF_BlueprintVisible)
	float                                              BarThickness;                                             // 0x0338(0x0004) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
...
{
	struct FSliderStyle                                SliderStyle;                                              // 0x0008(0x0340) (CPF_Edit)
	struct FSlateBrush                                 HighVolumeImage;                                          // 0x0348(0x0088) (CPF_Edit)
	struct FSlateBrush                                 MidVolumeImage;                                           // 0x03D0(0x0088) (CPF_Edit)
	struct FSlateBrush                                 LowVolumeImage;                                           // 0x0458(0x0088) (CPF_Edit)
	struct FSlateBrush                                 NoVolumeImage;                                            // 0x04E0(0x0088) (CPF_Edit)
	struct FSlateBrush                                 MutedImage;                                               // 0x0568(0x0088) (CPF_Edit)
};
...
{
	struct FEditableTextBoxStyle                       TextBoxStyle;                                             // 0x0008(0x07F8) (CPF_Edit)
	struct FSlateFontInfo                              ActiveFontInfo;                                           // 0x0800(0x0058) (CPF_Edit)
	struct FSlateBrush                                 UpArrowImage;                                             // 0x0858(0x0088) (CPF_Edit)
	struct FSlateBrush                                 DownArrowImage;                                           // 0x08E0(0x0088) (CPF_Edit)
	struct FSlateBrush                                 GlassImage;                                               // 0x0968(0x0088) (CPF_Edit)
	struct FSlateBrush                                 ClearImage;                                               // 0x09F0(0x0088) (CPF_Edit)
	struct FMargin                                     ImagePadding;                                             // 0x0A78(0x0010) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	bool                                               bLeftAlignButtons;                                        // 0x0A88(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
...
{
	struct FEditableTextBoxStyle                       EditableTextBoxStyle;                                     // 0x0008(0x07F8) (CPF_Edit, CPF_BlueprintVisible)
	struct FTextBlockStyle                             TextStyle;                                                // 0x0800(0x01E8) (CPF_Edit, CPF_BlueprintVisible)
};
...
struct FHyperlinkStyle : public FSlateWidgetStyle
{
	...
	struct FTextBlockStyle                             TextStyle;                                                // 0x0280(0x01E8) (CPF_Edit, CPF_BlueprintVisible)
	struct FMargin                                     Padding;                                                  // 0x0468(0x0010) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
};
...
struct FCheckBoxStyle : public FSlateWidgetStyle
{
	...
	struct FMargin                                     Padding;                                                  // 0x04D8(0x0010) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
