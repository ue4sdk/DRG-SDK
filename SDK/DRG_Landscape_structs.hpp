...
#include "DRG_Landscape_enums.hpp"
...
{
	struct FPerPlatformInt                             LODIndex;                                                 // 0x0000(0x0004) (CPF_Edit)
...
struct FLayerBlendInput
{
	...
	float                                              PreviewWeight;                                            // 0x0040(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	struct FVector                                     ConstLayerInput;                                          // 0x0044(0x000C) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	float                                              ConstHeightInput;                                         // 0x0050(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
