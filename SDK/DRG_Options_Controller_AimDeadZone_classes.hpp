...
#include "DRG_Options_Controller_AimDeadZone_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>("WidgetBlueprintGeneratedClass Options_Controller_AimDeadZone.Options_Controller_AimDeadZone_C");
		return ptr;
	}
