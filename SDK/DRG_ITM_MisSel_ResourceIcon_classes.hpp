...
#include "DRG_ITM_MisSel_ResourceIcon_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>("WidgetBlueprintGeneratedClass ITM_MisSel_ResourceIcon.ITM_MisSel_ResourceIcon_C");
		return ptr;
	}
