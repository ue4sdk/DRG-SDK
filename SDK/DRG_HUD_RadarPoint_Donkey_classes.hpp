...
#include "DRG_HUD_RadarPoint_Donkey_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>("WidgetBlueprintGeneratedClass HUD_RadarPoint_Donkey.HUD_RadarPoint_Donkey_C");
		return ptr;
	}
