...
#include "DRG_HUD_RadarPoint_Resupply_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>("WidgetBlueprintGeneratedClass HUD_RadarPoint_Resupply.HUD_RadarPoint_Resupply_C");
		return ptr;
	}
