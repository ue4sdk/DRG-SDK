...
#include "DRG_Tutorial_Hint_Flares_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>("BlueprintGeneratedClass Tutorial_Hint_Flares.Tutorial_Hint_Flares_C");
		return ptr;
	}
