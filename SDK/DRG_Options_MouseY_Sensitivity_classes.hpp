...
#include "DRG_Options_MouseY_Sensitivity_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>("WidgetBlueprintGeneratedClass Options_MouseY_Sensitivity.Options_MouseY_Sensitivity_C");
		return ptr;
	}
