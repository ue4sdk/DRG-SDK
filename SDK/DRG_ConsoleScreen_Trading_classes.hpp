...
#include "DRG_ConsoleScreen_Trading_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>("WidgetBlueprintGeneratedClass ConsoleScreen_Trading.ConsoleScreen_Trading_C");
		return ptr;
	}
