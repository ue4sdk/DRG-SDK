...
#include "DRG_MovieSceneTracks_enums.hpp"
#include "DRG_CoreUObject_classes.hpp"
#include "DRG_MovieScene_classes.hpp"
...
{
	struct FMovieSceneObjectBindingID                  Object;                                                   // 0x0000(0x0018) (CPF_Edit)
};
...
{
	TArray<struct FFrameNumber>                        KeyTimes;                                                 // 0x0008(0x0010) (CPF_ZeroConstructor)
	unsigned char                                      UnknownData00[0x18];                                      // 0x0018(0x0018) MISSED OFFSET
	TArray<struct FMovieSceneActorReferenceKey>        KeyValues;                                                // 0x0030(0x0010) (CPF_ZeroConstructor)
...
struct FMovieSceneCameraShakeSectionData
{
	...
	struct FRotator                                    UserDefinedPlaySpace;                                     // 0x0010(0x000C) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
...
{
	struct FName                                       EventName;                                                // 0x0000(0x0008) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
	struct FMovieSceneEventParameters                  Parameters;                                               // 0x0008(0x0028) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly)
};
...
struct FMovieSceneEventSectionData : public FMovieSceneChannel
{
	...
	TArray<struct FEventPayload>                       KeyValues;                                                // 0x0018(0x0010) (CPF_ZeroConstructor)
...
{
	TArray<struct FFrameNumber>                        KeyTimes;                                                 // 0x0008(0x0010) (CPF_ZeroConstructor)
	TArray<struct FMovieSceneEvent>                    KeyValues;                                                // 0x0018(0x0010) (CPF_ZeroConstructor)
	unsigned char                                      UnknownData00[0x60];                                      // 0x0028(0x0060) MISSED OFFSET
};
...
struct FMovieSceneSkeletalAnimationParams
{
	...
	bool                                               bSkipAnimNotifiers;                                       // 0x00C0(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
...
{
	TArray<struct FFrameNumber>                        Times;                                                    // 0x0008(0x0010) (CPF_ZeroConstructor)
	TArray<struct FString>                             Values;                                                   // 0x0018(0x0010) (CPF_ZeroConstructor)
	struct FString                                     DefaultValue;                                             // 0x0028(0x0010) (CPF_ZeroConstructor)
	bool                                               bHasDefaultValue;                                         // 0x0038(0x0001) (CPF_ZeroConstructor, CPF_IsPlainOldData)
...
struct FMovieScene3DAttachSectionTemplate : public FMovieSceneEvalTemplate
{
	...
	struct FName                                       AttachSocketName;                                         // 0x0038(0x0008) (CPF_ZeroConstructor, CPF_IsPlainOldData)
	struct FName                                       AttachComponentName;                                      // 0x0040(0x0008) (CPF_ZeroConstructor, CPF_IsPlainOldData)
	EAttachmentRule                                    AttachmentLocationRule;                                   // 0x0048(0x0001) (CPF_ZeroConstructor, CPF_IsPlainOldData)
	EAttachmentRule                                    AttachmentRotationRule;                                   // 0x0049(0x0001) (CPF_ZeroConstructor, CPF_IsPlainOldData)
	EAttachmentRule                                    AttachmentScaleRule;                                      // 0x004A(0x0001) (CPF_ZeroConstructor, CPF_IsPlainOldData)
	EDetachmentRule                                    DetachmentLocationRule;                                   // 0x004B(0x0001) (CPF_ZeroConstructor, CPF_IsPlainOldData)
	EDetachmentRule                                    DetachmentRotationRule;                                   // 0x004C(0x0001) (CPF_ZeroConstructor, CPF_IsPlainOldData)
	EDetachmentRule                                    DetachmentScaleRule;                                      // 0x004D(0x0001) (CPF_ZeroConstructor, CPF_IsPlainOldData)
...
struct FMovieScene3DPathSectionTemplate : public FMovieSceneEvalTemplate
{
	...
	EMovieScene3DPathSection_Axis                      FrontAxisEnum;                                            // 0x00D8(0x0001) (CPF_ZeroConstructor, CPF_IsPlainOldData)
	EMovieScene3DPathSection_Axis                      UpAxisEnum;                                               // 0x00D9(0x0001) (CPF_ZeroConstructor, CPF_IsPlainOldData)
...
{
	struct FVector                                     Location;                                                 // 0x0008(0x000C) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	struct FRotator                                    Rotation;                                                 // 0x0014(0x000C) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	struct FVector                                     Scale;                                                    // 0x0020(0x000C) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	struct FFrameNumber                                Time;                                                     // 0x002C(0x0004) (CPF_Edit)
...
{
	struct FVector                                     Scale;                                                    // 0x0008(0x000C) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	struct FFrameNumber                                Time;                                                     // 0x0014(0x0004) (CPF_Edit)
	unsigned char                                      UnknownData00[0x18];                                      // 0x0018(0x0018) MISSED OFFSET
};
...
{
	struct FRotator                                    Rotation;                                                 // 0x0008(0x000C) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	struct FFrameNumber                                Time;                                                     // 0x0014(0x0004) (CPF_Edit)
	unsigned char                                      UnknownData00[0x18];                                      // 0x0018(0x0018) MISSED OFFSET
};
...
struct FMovieScene3DTransformTemplateData
{
	...
	EMovieSceneBlendType                               BlendType;                                                // 0x0640(0x0001) (CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      UnknownData00[0x3];                                       // 0x0641(0x0003) MISSED OFFSET
	struct FMovieSceneTransformMask                    Mask;                                                     // 0x0644(0x0004)
	bool                                               bUseQuaternionInterpolation;                              // 0x0648(0x0001) (CPF_ZeroConstructor, CPF_IsPlainOldData)
...
struct FMovieSceneAudioSectionTemplateData
{
	...
	double                                             SectionStartTimeSeconds;                                  // 0x0010(0x0008) (CPF_ZeroConstructor, CPF_IsPlainOldData)
	...
	int                                                RowIndex;                                                 // 0x0158(0x0004) (CPF_ZeroConstructor, CPF_IsPlainOldData)
	bool                                               bOverrideAttenuation;                                     // 0x015C(0x0001) (CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      UnknownData01[0x3];                                       // 0x015D(0x0003) MISSED OFFSET
	class USoundAttenuation*                           AttenuationSettings;                                      // 0x0160(0x0008) (CPF_ZeroConstructor, CPF_IsPlainOldData)
	struct FScriptDelegate                             OnQueueSubtitles;                                         // 0x0168(0x0014) (CPF_ZeroConstructor, CPF_InstancedReference)
	struct FScriptMulticastDelegate                    OnAudioFinished;                                          // 0x0178(0x0010) (CPF_ZeroConstructor, CPF_InstancedReference)
	struct FScriptMulticastDelegate                    OnAudioPlaybackPercent;                                   // 0x0188(0x0010) (CPF_ZeroConstructor, CPF_InstancedReference)
};
...
struct FMovieSceneCameraCutSectionTemplate : public FMovieSceneEvalTemplate
{
	...
	struct FTransform                                  CutTransform;                                             // 0x0040(0x0030) (CPF_IsPlainOldData)
	bool                                               bHasCutTransform;                                         // 0x0070(0x0001) (CPF_ZeroConstructor, CPF_IsPlainOldData)
...
struct FMovieSceneColorKeyStruct : public FMovieSceneKeyStruct
{
	...
	struct FFrameNumber                                Time;                                                     // 0x0018(0x0004) (CPF_Edit)
...
{
	TArray<struct FMovieSceneObjectBindingID>          EventReceivers;                                           // 0x0020(0x0010) (CPF_ZeroConstructor)
...
{
	struct FName                                       EventToTrigger;                                           // 0x0038(0x0008) (CPF_ZeroConstructor, CPF_IsPlainOldData)
};
...
{
	TArray<struct FFrameNumber>                        EventTimes;                                               // 0x0038(0x0010) (CPF_ZeroConstructor)
	TArray<struct FName>                               EventFunctions;                                           // 0x0048(0x0010) (CPF_ZeroConstructor)
};
...
struct FMovieSceneFadeSectionTemplate : public FMovieSceneEvalTemplate
{
	...
	struct FLinearColor                                FadeColor;                                                // 0x00C0(0x0010) (CPF_ZeroConstructor, CPF_IsPlainOldData)
...
{
	ELevelVisibility                                   Visibility;                                               // 0x0020(0x0001) (CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      UnknownData00[0x7];                                       // 0x0021(0x0007) MISSED OFFSET
	TArray<struct FName>                               LevelNames;                                               // 0x0028(0x0010) (CPF_ZeroConstructor)
};
...
{
	TArray<struct FScalarParameterNameAndCurve>        Scalars;                                                  // 0x0020(0x0010) (CPF_ZeroConstructor)
	TArray<struct FVectorParameterNameAndCurves>       Vectors;                                                  // 0x0030(0x0010) (CPF_ZeroConstructor)
	TArray<struct FColorParameterNameAndCurves>        Colors;                                                   // 0x0040(0x0010) (CPF_ZeroConstructor)
};
...
{
	class UMaterialParameterCollection*                MPC;                                                      // 0x0050(0x0008) (CPF_ZeroConstructor, CPF_IsPlainOldData)
};
...
{
	int                                                MaterialIndex;                                            // 0x0050(0x0004) (CPF_ZeroConstructor, CPF_IsPlainOldData)
...
struct FMovieSceneVectorPropertySectionTemplate : public FMovieScenePropertySectionTemplate
{
	...
	int                                                NumChannelsUsed;                                          // 0x02C8(0x0004) (CPF_ZeroConstructor, CPF_IsPlainOldData)
	EMovieSceneBlendType                               BlendType;                                                // 0x02CC(0x0001) (CPF_ZeroConstructor, CPF_IsPlainOldData)
...
struct FMovieSceneIntegerPropertySectionTemplate : public FMovieScenePropertySectionTemplate
{
	...
	EMovieSceneBlendType                               BlendType;                                                // 0x00D8(0x0001) (CPF_ZeroConstructor, CPF_IsPlainOldData)
...
struct FMovieSceneFloatPropertySectionTemplate : public FMovieScenePropertySectionTemplate
{
	...
	EMovieSceneBlendType                               BlendType;                                                // 0x00E8(0x0001) (CPF_ZeroConstructor, CPF_IsPlainOldData)
...
struct FMovieSceneVector4KeyStruct : public FMovieSceneVectorKeyStructBase
{
	...
	struct FVector4                                    Vector;                                                   // 0x0030(0x0010) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
};
...
{
	struct FVector                                     Vector;                                                   // 0x0028(0x000C) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
...
{
	struct FVector2D                                   Vector;                                                   // 0x0028(0x0008) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
};
