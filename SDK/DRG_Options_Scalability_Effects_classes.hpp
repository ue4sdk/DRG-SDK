...
#include "DRG_Options_Scalability_Effects_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>("WidgetBlueprintGeneratedClass Options_Scalability_Effects.Options_Scalability_Effects_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_Options_Scalability_Effects(int EntryPoint);
};
