...
#include "DRG_Options_FullScreen_classes.hpp"
...
void UOptions_FullScreen_C::BndEvt__Basic_OptionSwitcher_K2Node_ComponentBoundEvent_18_OnSelectionChanged__DelegateSignature(const struct FText& Value, int Index)
{
