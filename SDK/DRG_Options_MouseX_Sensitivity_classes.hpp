...
#include "DRG_Options_MouseX_Sensitivity_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>("WidgetBlueprintGeneratedClass Options_MouseX_Sensitivity.Options_MouseX_Sensitivity_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_Options_MouseX_Sensitivity(int EntryPoint);
};
