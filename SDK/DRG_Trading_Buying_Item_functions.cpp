...
#include "DRG_Trading_Buying_Item_classes.hpp"
...
struct FEventReply UTrading_Buying_Item_C::OnMouseButtonUp(const struct FGeometry& MyGeometry, const struct FPointerEvent& MouseEvent)
{
...
void UTrading_Buying_Item_C::OnMouseEnter(const struct FGeometry& MyGeometry, const struct FPointerEvent& MouseEvent)
{
...
void UTrading_Buying_Item_C::OnMouseLeave(const struct FPointerEvent& MouseEvent)
{
