...
#include "DRG_EditableMesh_structs.hpp"
...
public:
	...
	TArray<class UEditableMeshAdapter*>                Adapters;                                                 // 0x0328(0x0010) (CPF_ZeroConstructor)
	int                                                TextureCoordinateCount;                                   // 0x0338(0x0004) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      UnknownData01[0xF8];                                      // 0x033C(0x00F8) MISSED OFFSET
	int                                                PendingCompactCounter;                                    // 0x0434(0x0004) (CPF_ZeroConstructor, CPF_IsPlainOldData)
	int                                                SubdivisionCount;                                         // 0x0438(0x0004) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
	...
	static struct FVertexID MakeVertexID(int VertexIndex);
	static struct FPolygonID MakePolygonID(int PolygonIndex);
	static struct FPolygonGroupID MakePolygonGroupID(int PolygonGroupIndex);
	static struct FEdgeID MakeEdgeID(int EdgeIndex);
	...
	struct FCoreUObject_FBox ComputeBoundingBox();
...
{
public:
	class UStaticMesh*                                 StaticMesh;                                               // 0x0028(0x0008) (CPF_ZeroConstructor, CPF_IsPlainOldData)
	class UStaticMesh*                                 OriginalStaticMesh;                                       // 0x0030(0x0008) (CPF_ZeroConstructor, CPF_IsPlainOldData)
	int                                                StaticMeshLODIndex;                                       // 0x0038(0x0004) (CPF_ZeroConstructor, CPF_IsPlainOldData)
