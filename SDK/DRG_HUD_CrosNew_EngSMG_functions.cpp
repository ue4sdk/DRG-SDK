...
#include "DRG_HUD_CrosNew_EngSMG_classes.hpp"
...
void UHUD_CrosNew_EngSMG_C::OnDamagedEnemy_Event(const TScriptInterface<class UHealth>& EnemyHealth, float Damage, float DamageModifier, float HealthRemaining)
{
