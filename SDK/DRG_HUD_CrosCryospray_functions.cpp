...
#include "DRG_HUD_CrosCryospray_classes.hpp"
...
void UHUD_CrosCryospray_C::OnDamagedEnemy_Event(const TScriptInterface<class UHealth>& EnemyHealth, float Damage, float DamageModifier, float HealthRemaining)
{
