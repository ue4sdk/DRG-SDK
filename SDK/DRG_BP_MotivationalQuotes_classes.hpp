...
#include "DRG_BP_MotivationalQuotes_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>("BlueprintGeneratedClass BP_MotivationalQuotes.BP_MotivationalQuotes_C");
		return ptr;
	}
