...
#include "DRG_Options_ShowSubtitles_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>("WidgetBlueprintGeneratedClass Options_ShowSubtitles.Options_ShowSubtitles_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_Options_ShowSubtitles(int EntryPoint);
};
