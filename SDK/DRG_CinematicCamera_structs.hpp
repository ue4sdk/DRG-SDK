...
#include "DRG_CinematicCamera_enums.hpp"
...
struct FCameraLookatTrackingSettings
{
	...
	struct FVector                                     RelativeOffset;                                           // 0x0020(0x000C) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
...
struct FCameraFocusSettings
{
	...
	struct FColor                                      DebugFocusPlaneColor;                                     // 0x0024(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
...
{
	struct FString                                     Name;                                                     // 0x0000(0x0010) (CPF_ZeroConstructor)
	struct FCameraLensSettings                         LensSettings;                                             // 0x0010(0x0018) (CPF_ZeroConstructor, CPF_IsPlainOldData)
};
