...
#include "DRG_MovieScene_structs.hpp"
...
{
public:
	struct FGuid                                       Signature;                                                // 0x0028(0x0010) (CPF_ZeroConstructor, CPF_IsPlainOldData)
...
public:
	...
	struct FMovieSceneRootEvaluationTemplateInstance   RootTemplateInstance;                                     // 0x0438(0x0300) (CPF_Transient)
...
public:
	...
	struct FFrameRate                                  TickResolution;                                           // 0x00B8(0x0008) (CPF_ZeroConstructor, CPF_IsPlainOldData)
	struct FFrameRate                                  DisplayRate;                                              // 0x00C0(0x0008) (CPF_ZeroConstructor, CPF_IsPlainOldData)
