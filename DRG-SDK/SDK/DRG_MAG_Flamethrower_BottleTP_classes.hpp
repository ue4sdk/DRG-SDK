...
#include "DRG_MAG_Flamethrower_BottleTP_structs.hpp"
...
class AMAG_Flamethrower_BottleTP_C : public AActor
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>("BlueprintGeneratedClass MAG_Flamethrower_BottleTP.MAG_Flamethrower_BottleTP_C");
		return ptr;
	}
