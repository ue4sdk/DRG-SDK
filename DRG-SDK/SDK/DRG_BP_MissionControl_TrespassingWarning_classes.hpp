...
#include "DRG_BP_MissionControl_TrespassingWarning_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>("BlueprintGeneratedClass BP_MissionControl_TrespassingWarning.BP_MissionControl_TrespassingWarning_C");
		return ptr;
	}
