...
#include "DRG_HUD_CroNewAssaultRifle_classes.hpp"
...
{
	static auto fn = UObject::FindObject<UFunction>("Function HUD_CroNewAssaultRifle.HUD_CroNewAssaultRifle_C.Construct");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function HUD_CroNewAssaultRifle.HUD_CroNewAssaultRifle_C.SetData");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function HUD_CroNewAssaultRifle.HUD_CroNewAssaultRifle_C.OnSpreadChanged");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function HUD_CroNewAssaultRifle.HUD_CroNewAssaultRifle_C.PreConstruct");
...
void UHUD_CroNewAssaultRifle_C::OnDamagedEnemy_Event(const TScriptInterface<class UHealth>& EnemyHealth, float Damage, float DamageModifier, float HealthRemaining)
{
	static auto fn = UObject::FindObject<UFunction>("Function HUD_CroNewAssaultRifle.HUD_CroNewAssaultRifle_C.OnDamagedEnemy_Event");
...
void UHUD_CroNewAssaultRifle_C::ExecuteUbergraph_HUD_CroNewAssaultRifle(int EntryPoint)
{
	static auto fn = UObject::FindObject<UFunction>("Function HUD_CroNewAssaultRifle.HUD_CroNewAssaultRifle_C.ExecuteUbergraph_HUD_CroNewAssaultRifle");
