...
#include "DRG_Foliage_structs.hpp"
...
public:
	...
	struct FScriptMulticastDelegate                    OnInstanceTakeRadialDamage;                               // 0x0778(0x0010) (CPF_ZeroConstructor, CPF_InstancedReference, CPF_BlueprintAssignable)
...
public:
	...
	static int FoliageOverlappingBoxCount(class UObject* WorldContextObject, class UStaticMesh* StaticMesh, const struct FCoreUObject_FBox& Box);
};
...
public:
	...
	struct FVector                                     CollisionScale;                                           // 0x00E4(0x000C) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	...
	struct FVector                                     LowBoundOriginRadius;                                     // 0x0110(0x000C) (CPF_ZeroConstructor, CPF_IsPlainOldData)
	...
	struct FBodyInstance                               BodyInstance;                                             // 0x0138(0x0150) (CPF_Edit)
	TEnumAsByte<EHasCustomNavigableGeometry>           CustomNavigableGeometry;                                  // 0x0288(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	struct FLightingChannels                           LightingChannels;                                         // 0x0289(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly)
	unsigned char                                      UnknownData11[0x2];                                       // 0x028A(0x0002) MISSED OFFSET
	unsigned char                                      bRenderCustomDepth : 1;                                   // 0x028C(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly)
	unsigned char                                      UnknownData12[0x3];                                       // 0x028D(0x0003) MISSED OFFSET
	int                                                CustomDepthStencilValue;                                  // 0x0290(0x0004) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
	...
	bool                                               bCanGrowInShade;                                          // 0x02B8(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	bool                                               bSpawnsInShade;                                           // 0x02B9(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	...
	struct FRuntimeFloatCurve                          ScaleCurve;                                               // 0x02D0(0x0078) (CPF_Edit)
	int                                                ChangeCount;                                              // 0x0348(0x0004) (CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      ReapplyDensity : 1;                                       // 0x034C(0x0001) (CPF_Edit, CPF_DisableEditOnInstance)
	unsigned char                                      ReapplyRadius : 1;                                        // 0x034C(0x0001) (CPF_Edit, CPF_DisableEditOnInstance)
	unsigned char                                      ReapplyAlignToNormal : 1;                                 // 0x034C(0x0001) (CPF_Edit, CPF_DisableEditOnInstance)
	unsigned char                                      ReapplyRandomYaw : 1;                                     // 0x034C(0x0001) (CPF_Edit, CPF_DisableEditOnInstance)
	unsigned char                                      ReapplyScaling : 1;                                       // 0x034C(0x0001) (CPF_Edit, CPF_DisableEditOnInstance)
	unsigned char                                      ReapplyScaleX : 1;                                        // 0x034C(0x0001) (CPF_Edit, CPF_DisableEditOnInstance)
	unsigned char                                      ReapplyScaleY : 1;                                        // 0x034C(0x0001) (CPF_Edit, CPF_DisableEditOnInstance)
	unsigned char                                      ReapplyScaleZ : 1;                                        // 0x034C(0x0001) (CPF_Edit, CPF_DisableEditOnInstance)
	unsigned char                                      ReapplyRandomPitchAngle : 1;                              // 0x034D(0x0001) (CPF_Edit, CPF_DisableEditOnInstance)
	unsigned char                                      ReapplyGroundSlope : 1;                                   // 0x034D(0x0001) (CPF_Edit, CPF_DisableEditOnInstance)
	unsigned char                                      ReapplyHeight : 1;                                        // 0x034D(0x0001) (CPF_Edit, CPF_DisableEditOnInstance)
	unsigned char                                      ReapplyLandscapeLayers : 1;                               // 0x034D(0x0001) (CPF_Edit, CPF_DisableEditOnInstance)
	unsigned char                                      ReapplyZOffset : 1;                                       // 0x034D(0x0001) (CPF_Edit, CPF_DisableEditOnInstance)
	unsigned char                                      ReapplyCollisionWithWorld : 1;                            // 0x034D(0x0001) (CPF_Edit, CPF_DisableEditOnInstance)
	unsigned char                                      ReapplyVertexColorMask : 1;                               // 0x034D(0x0001) (CPF_Edit, CPF_DisableEditOnInstance)
	unsigned char                                      bEnableDensityScaling : 1;                                // 0x034D(0x0001) (CPF_Edit)
...
{
public:
	class UStaticMesh*                                 Mesh;                                                     // 0x0350(0x0008) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	TArray<class UMaterialInterface*>                  OverrideMaterials;                                        // 0x0358(0x0010) (CPF_Edit, CPF_ZeroConstructor)
	class UClass*                                      ComponentClass;                                           // 0x0368(0x0008) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
...
public:
	...
	struct FVector                                     TouchingActorEntryPosition;                               // 0x0340(0x000C) (CPF_ZeroConstructor, CPF_Transient, CPF_IsPlainOldData)
	struct FVector                                     FoliageVelocity;                                          // 0x034C(0x000C) (CPF_ZeroConstructor, CPF_Transient, CPF_IsPlainOldData)
	struct FVector                                     FoliageForce;                                             // 0x0358(0x000C) (CPF_ZeroConstructor, CPF_Transient, CPF_IsPlainOldData)
	struct FVector                                     FoliagePosition;                                          // 0x0364(0x000C) (CPF_ZeroConstructor, CPF_Transient, CPF_IsPlainOldData)
...
public:
	...
	struct FGuid                                       ProceduralGuid;                                           // 0x0108(0x0010) (CPF_ZeroConstructor, CPF_IsPlainOldData)
