...
#include "DRG_ClothingSystemRuntime_structs.hpp"
...
public:
	...
	struct FClothConfig                                ClothConfig;                                              // 0x0050(0x00D4) (CPF_Edit)
	unsigned char                                      UnknownData00[0x4];                                       // 0x0124(0x0004) MISSED OFFSET
	TArray<struct FClothLODData>                       LODData;                                                  // 0x0128(0x0010) (CPF_ZeroConstructor)
	TArray<int>                                        LodMap;                                                   // 0x0138(0x0010) (CPF_ZeroConstructor)
	TArray<struct FName>                               UsedBoneNames;                                            // 0x0148(0x0010) (CPF_ZeroConstructor)
	TArray<int>                                        UsedBoneIndices;                                          // 0x0158(0x0010) (CPF_ZeroConstructor)
	int                                                ReferenceBoneIndex;                                       // 0x0168(0x0004) (CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      UnknownData01[0x4];                                       // 0x016C(0x0004) MISSED OFFSET
	class UClothingAssetCustomData*                    CustomData;                                               // 0x0170(0x0008) (CPF_ZeroConstructor, CPF_IsPlainOldData)
