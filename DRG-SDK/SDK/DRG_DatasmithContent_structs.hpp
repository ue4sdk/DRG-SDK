...
#include "DRG_DatasmithContent_enums.hpp"
#include "DRG_CoreUObject_classes.hpp"
#include "DRG_Engine_classes.hpp"
#include "DRG_CinematicCamera_classes.hpp"
...
{
	ECameraFocusMethod                                 FocusMethod;                                              // 0x0000(0x0001) (CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      UnknownData00[0x3];                                       // 0x0001(0x0003) MISSED OFFSET
	float                                              ManualFocusDistance;                                      // 0x0004(0x0004) (CPF_ZeroConstructor, CPF_IsPlainOldData)
};
...
struct FDatasmithPostProcessSettingsTemplate
{
	...
	struct FLinearColor                                FilmWhitePoint;                                           // 0x000C(0x0010) (CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      UnknownData01[0x4];                                       // 0x001C(0x0004) MISSED OFFSET
	struct FVector4                                    ColorSaturation;                                          // 0x0020(0x0010) (CPF_ZeroConstructor, CPF_IsPlainOldData)
