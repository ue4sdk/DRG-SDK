...
#include "DRG_DatasmithContent_structs.hpp"
...
public:
	...
	struct FVector2D                                   Dimensions;                                               // 0x032C(0x0008) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
	struct FLinearColor                                Color;                                                    // 0x0334(0x0010) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
...
public:
	...
	struct FVector2D                                   Dimensions;                                               // 0x002C(0x0008) (CPF_ZeroConstructor, CPF_IsPlainOldData)
	struct FLinearColor                                Color;                                                    // 0x0034(0x0010) (CPF_ZeroConstructor, CPF_IsPlainOldData)
...
{
public:
	struct FDatasmithCameraFilmbackSettingsTemplate    FilmbackSettings;                                         // 0x0028(0x0008) (CPF_ZeroConstructor, CPF_IsPlainOldData)
	struct FDatasmithCameraLensSettingsTemplate        LensSettings;                                             // 0x0030(0x0004) (CPF_ZeroConstructor, CPF_IsPlainOldData)
	struct FDatasmithCameraFocusSettingsTemplate       FocusSettings;                                            // 0x0034(0x0008) (CPF_ZeroConstructor, CPF_IsPlainOldData)
	float                                              CurrentFocalLength;                                       // 0x003C(0x0004) (CPF_ZeroConstructor, CPF_IsPlainOldData)
	float                                              CurrentAperture;                                          // 0x0040(0x0004) (CPF_ZeroConstructor, CPF_IsPlainOldData)
...
{
public:
	class UMaterialInterface*                          LandscapeMaterial;                                        // 0x0028(0x0008) (CPF_ZeroConstructor, CPF_IsPlainOldData)
	int                                                StaticLightingLOD;                                        // 0x0030(0x0004) (CPF_ZeroConstructor, CPF_IsPlainOldData)
...
public:
	...
	struct FLinearColor                                LightColor;                                               // 0x003C(0x0010) (CPF_ZeroConstructor, CPF_IsPlainOldData)
...
public:
	...
	TSoftObjectPtr<class USceneComponent>              AttachParent;                                             // 0x0068(0x0028) (CPF_ExportObject, CPF_InstancedReference)
...
{
public:
	class UStaticMesh*                                 StaticMesh;                                               // 0x00E0(0x0008) (CPF_ZeroConstructor, CPF_IsPlainOldData)
	TArray<class UMaterialInterface*>                  OverrideMaterials;                                        // 0x00E8(0x0010) (CPF_ZeroConstructor)
