...
#include "DRG_HUD_CrosNewMinigun_classes.hpp"
...
void UHUD_CrosNewMinigun_C::OnDamagedEnemy_Event(const TScriptInterface<class UHealth>& EnemyHealth, float Damage, float DamageModifier, float HealthRemaining)
{
