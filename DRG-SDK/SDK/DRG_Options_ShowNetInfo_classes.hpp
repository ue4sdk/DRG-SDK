...
#include "DRG_Options_ShowNetInfo_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>("WidgetBlueprintGeneratedClass Options_ShowNetInfo.Options_ShowNetInfo_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_Options_ShowNetInfo(int EntryPoint);
};
