...
#include "DRG_Options_FullScreen_UWP_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>("WidgetBlueprintGeneratedClass Options_FullScreen_UWP.Options_FullScreen_UWP_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_Options_FullScreen_UWP(int EntryPoint);
};
