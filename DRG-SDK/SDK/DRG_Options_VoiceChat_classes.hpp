...
#include "DRG_Options_VoiceChat_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>("WidgetBlueprintGeneratedClass Options_VoiceChat.Options_VoiceChat_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_Options_VoiceChat(int EntryPoint);
};
