...
#include "DRG_BP_SelectCharacterOnlyConsole_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>("BlueprintGeneratedClass BP_SelectCharacterOnlyConsole.BP_SelectCharacterOnlyConsole_C");
		return ptr;
	}
