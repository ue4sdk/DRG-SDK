...
#include "DRG_GameplayTasks_structs.hpp"
...
public:
	...
	TArray<class UGameplayTask*>                       KnownTasks;                                               // 0x0140(0x0010) (CPF_ZeroConstructor, CPF_Transient)
	struct FScriptMulticastDelegate                    OnClaimedResourcesChange;                                 // 0x0150(0x0010) (CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_InstancedReference)
