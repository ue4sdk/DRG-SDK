...
#include "DRG_EditableMesh_classes.hpp"
...
// Parameters:
// struct FVector                 LineSegmentStart               (CPF_ConstParm, CPF_Parm, CPF_ZeroConstructor, CPF_IsPlainOldData)
// struct FVector                 LineSegmentEnd                 (CPF_ConstParm, CPF_Parm, CPF_ZeroConstructor, CPF_IsPlainOldData)
...
// Parameters:
// TArray<struct FPlane>          planes                         (CPF_ConstParm, CPF_Parm, CPF_OutParm, CPF_ZeroConstructor, CPF_ReferenceParm)
// TArray<struct FPolygonID>      OutPolygons                    (CPF_Parm, CPF_OutParm, CPF_ZeroConstructor)
...
// struct FVector                 ReferencePosition              (CPF_ConstParm, CPF_Parm, CPF_ZeroConstructor, CPF_IsPlainOldData)
...
// (FUNC_Final, FUNC_Native, FUNC_Public, FUNC_HasDefaults, FUNC_BlueprintCallable, FUNC_BlueprintPure, FUNC_Const)
// Parameters:
// struct FCoreUObject_FBox       ReturnValue                    (CPF_Parm, CPF_OutParm, CPF_ZeroConstructor, CPF_ReturnParm, CPF_IsPlainOldData)

struct FCoreUObject_FBox UEditableMesh::ComputeBoundingBox()
{
	static auto fn = UObject::FindObject<UFunction>("Function EditableMesh.EditableMesh.ComputeBoundingBox");

	struct
	{
		struct FCoreUObject_FBox       ReturnValue;
	} params;
...
// Parameters:
// struct FPolygonID              PolygonID                      (CPF_ConstParm, CPF_Parm)
// struct FVector                 PointOnPolygon                 (CPF_ConstParm, CPF_Parm, CPF_ZeroConstructor, CPF_IsPlainOldData)
// struct FMeshTriangle           OutTriangle                    (CPF_Parm, CPF_OutParm)
// struct FVector                 OutTriangleVertexWeights       (CPF_Parm, CPF_OutParm, CPF_ZeroConstructor, CPF_IsPlainOldData)
// bool                           ReturnValue                    (CPF_Parm, CPF_OutParm, CPF_ZeroConstructor, CPF_ReturnParm, CPF_IsPlainOldData)
