...
#include "DRG_EngineSettings_structs.hpp"
...
{
public:
	struct FSoftObjectPath                             EditorStartupMap;                                         // 0x0028(0x0018) (CPF_Edit, CPF_ZeroConstructor, CPF_Config)
	struct FString                                     LocalMapOptions;                                          // 0x0040(0x0010) (CPF_Edit, CPF_ZeroConstructor, CPF_Config)
	struct FSoftObjectPath                             TransitionMap;                                            // 0x0050(0x0018) (CPF_Edit, CPF_ZeroConstructor, CPF_Config)
	...
	EFourPlayerSplitScreenType                         FourPlayerSplitscreenLayout;                              // 0x006B(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_Config, CPF_IsPlainOldData)
	bool                                               bOffsetPlayerGamepadIds;                                  // 0x006C(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_Config, CPF_IsPlainOldData)
	unsigned char                                      UnknownData00[0x3];                                       // 0x006D(0x0003) MISSED OFFSET
	struct FSoftClassPath                              GameInstanceClass;                                        // 0x0070(0x0018) (CPF_Edit, CPF_ZeroConstructor, CPF_Config, CPF_NoClear)
	struct FSoftObjectPath                             GameDefaultMap;                                           // 0x0088(0x0018) (CPF_Edit, CPF_ZeroConstructor, CPF_Config)
	struct FSoftObjectPath                             ServerDefaultMap;                                         // 0x00A0(0x0018) (CPF_Edit, CPF_ZeroConstructor, CPF_Config)
	struct FSoftClassPath                              GlobalDefaultGameMode;                                    // 0x00B8(0x0018) (CPF_Edit, CPF_ZeroConstructor, CPF_Config, CPF_NoClear)
	struct FSoftClassPath                              GlobalDefaultServerGameMode;                              // 0x00D0(0x0018) (CPF_Edit, CPF_ZeroConstructor, CPF_Config)
