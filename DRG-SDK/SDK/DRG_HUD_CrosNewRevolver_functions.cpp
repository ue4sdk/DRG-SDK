...
#include "DRG_HUD_CrosNewRevolver_classes.hpp"
...
void UHUD_CrosNewRevolver_C::Construct()
{
	static auto fn = UObject::FindObject<UFunction>("Function HUD_CrosNewRevolver.HUD_CrosNewRevolver_C.Construct");
...
void UHUD_CrosNewRevolver_C::SetData(class AItem* Item)
{
	static auto fn = UObject::FindObject<UFunction>("Function HUD_CrosNewRevolver.HUD_CrosNewRevolver_C.SetData");
...
void UHUD_CrosNewRevolver_C::OnSpreadChanged(float HorizontalSpread, float VerticalSpread, bool isAtRest)
{
	static auto fn = UObject::FindObject<UFunction>("Function HUD_CrosNewRevolver.HUD_CrosNewRevolver_C.OnSpreadChanged");
...
void UHUD_CrosNewRevolver_C::PreConstruct(bool IsDesignTime)
{
	static auto fn = UObject::FindObject<UFunction>("Function HUD_CrosNewRevolver.HUD_CrosNewRevolver_C.PreConstruct");
...
void UHUD_CrosNewRevolver_C::OnDamagedEnemy_Event(const TScriptInterface<class UHealth>& EnemyHealth, float Damage, float DamageModifier, float HealthRemaining)
{
	static auto fn = UObject::FindObject<UFunction>("Function HUD_CrosNewRevolver.HUD_CrosNewRevolver_C.OnDamagedEnemy_Event");
...
void UHUD_CrosNewRevolver_C::ExecuteUbergraph_HUD_CrosNewRevolver(int EntryPoint)
{
	static auto fn = UObject::FindObject<UFunction>("Function HUD_CrosNewRevolver.HUD_CrosNewRevolver_C.ExecuteUbergraph_HUD_CrosNewRevolver");
